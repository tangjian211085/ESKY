...
//                    .setAutoCancel(true)
//                    .setSmallIcon(R.mipmap.icon_return)
...
//        } else
    ...
    class RemoteBinder extends IGuardAidlInterface.Stub {
        @Override
    ...
    class RemoteServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            DMLog.e(this.getClass().getCanonicalName(), "RemoteService onServiceConnected");
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            startService(new Intent(RemoteService.this, LocalService.class));
            bindService(new Intent(RemoteService.this, LocalService.class), mConnection, BIND_AUTO_CREATE);
        }
    }
