...
public class ScrollViewContainer extends RelativeLayout {
    ...
    private OnPullScrollViewListener listener;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        bottomView.layout(0, mViewHeight + (int) mMoveLen, mViewWidth,
...
//			mViewHeight = topView.getMeasuredHeight();
    ...
    public void setOnPullScrollViewListener(OnPullScrollViewListener listener) {
        this.listener = listener;
    }

    public interface OnPullScrollViewListener {
        /**
         * 滑动到第一页
         */
        void toPageOneRefresh();

        /**
         * 滑动到第二页
         */
        void toPageTwoRefresh();
    }
