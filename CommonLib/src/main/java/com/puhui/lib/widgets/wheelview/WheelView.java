...
package com.puhui.lib.widgets.wheelview;
...
import com.puhui.lib.widgets.wheelview.adapters.WheelViewAdapter;
...
//    private int[] SHADOWS_COLORS = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};
    private int[] SHADOWS_COLORS = new int[]{0xccffffff, 0x99ffffff, 0x00ffffff};
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(ContextCompat.getColor(getContext(), R.color.wheel_view_line_border));
        // 设置线宽
    ...
    private void createItemsLayout() {
        if (itemsLayout == null) {
            ...
            itemsLayout.setBackgroundResource(wheelBackground);
