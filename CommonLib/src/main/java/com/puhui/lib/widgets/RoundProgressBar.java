    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (style) {
            case STROKE: {
                ...
                canvas.drawArc(mOval, -90, 360 * progress / max, false, paint); // 根据进度画圆弧
                break;
            }
            case FILL: {
                paint.setStyle(Paint.Style.FILL_AND_STROKE);
                if (progress != 0)
                    canvas.drawArc(mOval, -90, 360 * progress / max, true, paint); // 根据进度画圆弧
                break;
            }
        }
...
//		}
    ...
    /**
     * @param progressText 对progressText进行赋值
     */
