...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    /**
     * 点击与触摸的切换阀值
     * see isClick      if (Math.abs(mDownPointY - event.getY()) < mTouchSlop) {
     * isClick = true;     break;      }
     */
    ...
    private void computeIndicatorRect() {
        ...
        int indicatorHeadCenterY = mWheelCenterY + (int) (mHalfItemHeight * 1.5);
        int indicatorFootCenterY = mWheelCenterY - (int) (mHalfItemHeight * 1.5);
