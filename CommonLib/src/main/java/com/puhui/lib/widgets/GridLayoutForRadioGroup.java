...
/**
 * 使用GridLayout的RadioGroup
 * @author  tangjian
 * @date 2015年11月16日
 */
public class GridLayoutForRadioGroup extends GridLayout
{
	 ...
	 * {@inheritDoc}
	 */
	public GridLayoutForRadioGroup(Context context)
	{
		super(context);
		init();
	}
	 ...
	 * {@inheritDoc}
	 */
	public GridLayoutForRadioGroup(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
	...
	private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener
	{
		...
		{
			if ((parent == GridLayoutForRadioGroup.this && child instanceof RadioButton))
			{
				if (child != null)
				{
					int id = child.getId();
