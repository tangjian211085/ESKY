...
public class SharedPreferenceUtils {
    private static final String DEFAULT_FILE_NAME = "sharedPreference";
    ...
    public static final String LAST_LOGIN_ACCOUNT = "lastLoginAccount";  //上次登录账号
    public static final String KEY_HAS_LOCKED = "";

    public static void put(Context context, String fileName, String key, Object object) {
        SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();

        putData2SP(key, object, editor);
    ...
    private static void putData2SP(String key, Object object, SharedPreferences.Editor editor) {
